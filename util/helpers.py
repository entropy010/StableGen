...
prompt_text_chroma = """ 
{
  ...
  "11": {
    "inputs": {
      "clip_name1": "t5xxl_fp8_e4m3fn.safetensors",
      "clip_name2": "Long-ViT-L-14-REG-GATED-full-model.safetensors",
      "type": "flux",
      "device": "default"
    },
    "class_type": "DualCLIPLoader",
  ...
  "12": {
    "inputs": {
      "unet_name": "FLUX_chroma-unlocked-v33-Q8_0.gguf",
      "weight_dtype": "default"
    },
    "class_type": "UnetLoaderGGUF",
    "_meta": {
      "title": "Load Diffusion Model (GGUF)"
    }
  },
  "13": {
    "inputs": {
